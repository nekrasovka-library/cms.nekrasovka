const initialState = {
      ...
      variants: [
        {
          ...
          type: "text",
          text: [
            '<div>Book design is the art of incorporating the content, style, format, design, and sequence of the various components of a book into a coherent whole. In the words of Jan Tschichold, book designer, "methods and rules upon which it is impossible to improve, have been developed over centuries. To produce perfect books, these rules have to be brought back to life and applied.</div>',
            "<div>Visual aids are often used to help audiences of informative and persuasive speeches understand the topic being presented. Visual aids can play a large role in how the audience understands and takes in information that is presented.</div>",
          ],
          menuId: 6,
          styles: {
            maxWidth: "12",
  ...
  <div style="display: flex; align-items: center; column-gap: 10px;">
    ...
    <div>
      ...
      <a href="//biblioteka.nekrasovka.ru/addresses" target="_blank" style="display: flex; align-items: center; column-gap: 5px;"><span style="color: #777777; font-size: 13px;">Адреса и часы работы</span>
