...
const Settings = () => {
  ...
  }, [blocks.data, settings, blocks.selectedBlockIndex]);
  ...
  return (
    <Container1 $isMenuOpen={isSettingsOpen}>
      ...
      <PaddingContainer>
        <div>
          <PaddingLabel>Отступ сверху</PaddingLabel>
          <PaddingSelect
            name="paddingTop"
          ...
          >
            ...
            <option value="30px">1 line (30px)</option>
        ...
        <div>
          <PaddingLabel>Отступ снизу</PaddingLabel>
          <PaddingSelect
            name="paddingBottom"
            onChange={handleChange}
